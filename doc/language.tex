...
The loop construct syntax can be seen in \autoref{table:for-loop-inverse}.
\begin{table}[!h]
    \centering
    \begin{tabular}{l}
...
Hence by the above proofs, and the one for \texttt{Janus} from-loops in \cite{janus}, \lan
