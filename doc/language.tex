...
%    2. Maybe small example programs
...
\begin{equation} \label{eq:loop1Main}
    \frac{\sigma \vdash_{local} \text{local } t \text{ id } = e_1 \leadsto \sigma' ~~
        \substack{\sigma' \vdash_{expr} e_3 \leadsto v \\
            v == false} ~~
        \sigma' \vdash_{loop1} (e_1, s, e_2, e_3) \leadsto \sigma''}
    {\sigma \vdash_{stmt} \text{for local }t\text{ id }= e_1 ~\{s\}\text{ id }\oplus= e_2, \text{until (dealloc } t\text{ id }= e_3) \leadsto \sigma''}
    \text{\texttt{Loop1Main}}
\end{equation}

\begin{equation} \label{eq:loop1MainBase}
    \frac{\sigma \vdash_{local} \text{local } t \text{ id } = e_1 \leadsto \sigma' ~~
        \sigma' \vdash_{expr} e_3 \leadsto v ~~
        v == true}
    {\sigma \vdash_{stmt} \text{for local }t\text{ id }= e_1 ~\{s\}\text{ id }\oplus= e_2, \text{until (dealloc } t\text{ id }= e_3) \leadsto \sigma}
    \text{\texttt{Loop1MainBase}}
\end{equation}
...
\begin{equation} \label{eq:loop1Rec}
    \frac{\substack{\sigma \vdash_{expr} e_3 \leadsto v_1 \\
        ...
        \sigma' \vdash_{AssVar} id \oplus= e_2 \leadsto \sigma'' ~~
        \substack{\sigma \vdash_{expr} e_1 \leadsto v_2 \\
            v_2 == false} ~~
        \sigma'' \vdash_{Loop1} (s, e_2, e_3) \leadsto \sigma'''}
    {\sigma \vdash_{Loop1} (e_1, s, e_2, e_3) \leadsto \sigma'''}
    \text{\texttt{Loop1Rec}}
\end{equation}
...
\begin{equation} \label{eq:loop2Main}
    ...
    {\sigma \vdash_{stmt} \text{for local }t\text{ id }= e_1,\text{ id }\oplus= e_2 ~\{s\} \text{ until (dealloc } t\text{ id }= e_3) \leadsto \sigma''}
    \text{\texttt{Loop2Main}}
\end{equation}

\begin{equation} \label{eq:loop2MainBase}
    \frac{\sigma \vdash_{local} \text{local } t \text{ id } = e_1 \leadsto \sigma' ~~
        \sigma' \vdash_{expr} e_3 \leadsto v ~~
        v == true}
    {\sigma \vdash_{stmt} \text{for local }t\text{ id }= e_1,\text{ id }\oplus= e_2 ~\{s\} \text{ until (dealloc } t\text{ id }= e_3) \leadsto \sigma}
    \text{\texttt{Loop2MainBase}}
\end{equation}
...
\begin{equation} \label{eq:loop1MainInv}
    \frac{\sigma \vdash_{local} \text{local } t \text{ id } = e_1 \leadsto \sigma' ~~
        ...
        \substack{\sigma' \vdash_{loop1} (e_1, e_2, s, e_3, e_4) \leadsto \sigma'' \\
            \sigma'' \vdash_{expr} e_2 \leadsto true}}
    {\sigma \vdash_{stmt} \text{for local }t\text{ id }= e_1, \text{ invariant }(e_2) ~\{s\}\text{ id }\oplus= e_3, \text{until (dealloc } t\text{ id }= e_4) \leadsto \sigma''}
    \text{\texttt{Loop1MainInv}}
\end{equation}

\begin{equation} \label{eq:loop1MainBaseInv}
    \frac{\sigma \vdash_{local} \text{local } t \text{ id } = e_1 \leadsto \sigma' ~~
        \sigma' \vdash_{expr} e_4 \leadsto true ~~
        \sigma' \vdash_{expr} e_2 \leadsto true}
    {\sigma \vdash_{stmt} \text{for local }t\text{ id }= e_1, \text{ invariant }(e_2) ~\{s\}\text{ id }\oplus= e_3, \text{until (dealloc } t\text{ id }= e_4) \leadsto \sigma}
    \text{\texttt{Loop1MainBaseInv}}
\end{equation}
...
\begin{equation} \label{eq:loop1RecInv}
    \frac{\substack{\sigma \vdash_{expr} e_4 \leadsto v_1 \\
            ...
            \sigma \vdash_{expr} e_2 \leadsto true} ~~
        \sigma \vdash_{stmt} s \leadsto \sigma' ~~
        \sigma' \vdash_{AssVar} id \oplus= e_3 \leadsto \sigma'' ~~
        \substack{\sigma'' \vdash_{Loop1} (e_1, e_2, s, e_3, e_4) \leadsto \sigma''' \\
        \sigma''' \vdash_{expr} e_2 \leadsto true}}
...
\begin{equation} \label{eq:loop2MainInv}
    \frac{\sigma \vdash_{local} \text{local } t \text{ id } = e_1 \leadsto \sigma' ~~
        ...
        \substack{\sigma' \vdash_{loop1} (e_1, e_2, s, e_3, e_4) \leadsto \sigma'' \\
            \sigma'' \vdash_{expr} e_2 \leadsto true}}
    {\sigma \vdash_{stmt} \text{for local }t\text{ id }= e_1, \text{ invariant }(e_2), \text{ id }\oplus= e_3 ~\{s\} \text{ until (dealloc } t\text{ id }= e_4) \leadsto \sigma''}
    \text{\texttt{Loop2MainInv}}
\end{equation}

\begin{equation} \label{eq:loop2MainBaseInv}
    \frac{\sigma \vdash_{local} \text{local } t \text{ id } = e_1 \leadsto \sigma' ~~
        \sigma' \vdash_{expr} e_4 \leadsto true ~~
        \sigma' \vdash_{expr} e_2 \leadsto true}
    {\sigma \vdash_{stmt} \text{for local }t\text{ id }= e_1, \text{ invariant }(e_2), \text{ id }\oplus= e_3 ~\{s\} \text{ until (dealloc } t\text{ id }= e_4) \leadsto \sigma}
    \text{\texttt{Loop2MainBaseInv}}
\end{equation}
...
\eqref{eq:loop1Main} and \eqref{eq:loop1MainBase} defines the semantics of the simple
