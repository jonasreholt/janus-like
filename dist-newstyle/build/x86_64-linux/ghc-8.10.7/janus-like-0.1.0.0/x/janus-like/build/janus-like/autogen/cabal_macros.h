...
/* package janus-like-0.1.0.0 */
#ifndef VERSION_janus_like
#define VERSION_janus_like "0.1.0.0"
#endif /* VERSION_janus_like */
#ifndef MIN_VERSION_janus_like
#define MIN_VERSION_janus_like(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_janus_like */
...
#define CURRENT_COMPONENT_ID "janus-like-0.1.0.0-inplace-janus-like"
